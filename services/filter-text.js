    ...
    try {
        if (options.line1) {
            filters.push({
                ...
                )}:\'text=\'${await parse(options?.line1, options)}\':fontcolor=${
        ...
        if (options.line2) {
            filters.push({
                ...
                options: `fontfile=\'${path.join(
                    ...
                    "fonts",
                    `${options?.font || "swansea-bold.ttf"}`
                )}:\'text=\'${await parse(options?.line2, options)}\':fontcolor=${
                    options?.textColor || "white"
                }:fontsize=${fontSize}:box=1:boxcolor=${
                    options?.backgroundColor || "black"
                }@0.5:boxborderw=8:x=(w-text_w)/2:y=((h-text_h)/2)+${parseInt(fontSize * 0.6)}`,
            ...
            if (options.topRight.line1) {
                filters.push({
                    ...
                    options: `fontfile=\'${path.join(
                        ...
                        "fonts",
                        `${options?.font || "swansea-bold.ttf"}`
                    )}:\'text=\'${await parse(options.topRight.line1, options)}\':fontcolor=${
                        options?.textColor || "white"
            ...
            if (options.topRight.line2) {
                filters.push({
                    ...
                    options: `fontfile=\'${path.join(
                        ...
                        "fonts",
                        `${options?.font || "swansea-bold.ttf"}`
                    )}:\'text=\'${await parse(options.topRight.line2, options)}\':fontcolor=${
                        options?.textColor || "white"
                    }:fontsize=${parseInt(fontSize / 2)}:box=1:boxcolor=${
                        options?.backgroundColor || "black"
